...
Console.WriteLine($"{Convert.ToString(decimalNotation, 2)}");
Console.WriteLine($"{Convert.ToString(binaryNotation, 2)}");
Console.WriteLine($"{Convert.ToString(hexadecimalNotation, 2)}");
